  ...
  return (
    <PageTransition>
      <div className={`min-h-screen ${isDark ? 'bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white' : 'bg-white text-slate-900'}`}>
        <Header />
        <div className="h-20" />
        <ScrollFadeIn yOffset={32}><div className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 pb-20">
          <ScrollFadeIn yOffset={24} delay={0.04}><div className="grid md:grid-cols-3 gap-8 mb-12">
            {/** contact cards **/}
            {[
              {
                icon: Mail,
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <ScrollFadeIn yOffset={20} delay={0.08}><div className={`${isDark ? 'bg-slate-800/50 border-slate-700 text-white' : 'bg-white/60 border-slate-200 text-slate-900'} backdrop-blur-sm border rounded-xl p-8`}>
            ...
            <ScrollFadeIn yOffset={18} delay={0.10}><div className="space-y-6">
