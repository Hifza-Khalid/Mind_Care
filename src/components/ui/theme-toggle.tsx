...
export function ThemeToggle() {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="bg-white/10 backdrop-blur-2xl border-white/20 shadow-floating rounded-2xl min-w-[220px]">
        ...
        <DropdownMenuItem onClick={() => setTheme('auto')} className="p-3 rounded-xl hover:bg-white/10 transition-all duration-200 group">
        ...
        <DropdownMenuItem onClick={toggleReadingMode} className="p-3 rounded-xl hover:bg-white/10 transition-all duration-200 group">
        ...
        <DropdownMenuItem asChild className="p-3 rounded-xl hover:bg-white/10 transition-all duration-200 group">
