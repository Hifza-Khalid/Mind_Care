...
export const MindfulnessProgressTracker: React.FC<MindfulnessProgressTrackerProps> = ({
  ...
  const [progress, setProgress] = useState<MindfulnessProgress>({
    ...
    achievements: [
      { ...MEDITATION_ACHIEVEMENTS[0], isUnlocked: true, unlockedDate: '2024-01-01', currentProgress: 1 },
      { ...MEDITATION_ACHIEVEMENTS[1], isUnlocked: true, unlockedDate: '2024-01-08', currentProgress: 7 },
  ...
  const weeklyGoalProgress = calculateWeeklyGoalProgress(progress.weeklyProgress, progress.weeklyGoal);
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-2xl font-bold">{formatMeditationTime(progress.totalMeditationTime * 60)}</p>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    <p className="font-medium">{formatMeditationTime(progress.averageSessionDuration * 60)}</p>
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <p className="text-sm font-medium">
                            {'type' in session ? session.type.replace('-', ' ') : session.technique.replace('-', ' ')}
                          </p>
            ...
            <CardContent>
              <div className="space-y-4">
                {progress.weeklyStats.map((week, index) => (
                  <div key={week.weekStartDate} className="flex items-center justify-between p-4 border rounded-lg">
                    ...
                    <div className="text-right">
                      <p className="text-sm font-medium">Week of {new Date(week.weekStartDate).toLocaleDateString()}</p>
                      <div className="flex items-center space-x-1 mt-1">
                        <span className="text-sm">{getMeditationTypeIcon(week.mostUsedTechnique)}</span>
                        <span className="text-xs text-muted-foreground">{week.mostUsedTechnique.replace('-', ' ')}</span>
                      </div>
                    </div>
                  </div>
                ))}
        ...
        <TabsContent value="goals" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Set your weekly meditation time goal
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span>{Math.min(progress.currentStreak + (7 - (progress.currentStreak % 7)), progress.currentStreak + 7)} days</span>
                </div>
                <Progress 
                  value={(progress.currentStreak % 7) * (100 / 7)} 
                  className="h-2" 
                />
              </div>
            </CardContent>
              ...
              <CardContent>
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-2">
                      <Progress 
                        value={(nextAchievement.currentProgress / nextAchievement.requirement) * 100} 
                        className="h-2" 
                      />
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3 p-3 bg-blue-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      You tend to meditate most on Sundays with an average of 25 minutes per session.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3 p-3 bg-green-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Your session duration has increased by 15% over the past month. Great consistency!
                    </p>
                  </div>
                </div>
