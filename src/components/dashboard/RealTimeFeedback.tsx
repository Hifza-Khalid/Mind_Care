...
export const RealTimeFeedback: React.FC<RealTimeFeedbackProps> = ({
  ...
  const getColors = () => {
    switch (type) {
      ...
      case 'achievement': return 'bg-yellow-50 border-yellow-200 text-yellow-800';
...
export const StreakCounter: React.FC<{
  ...
  return (
    <div className={`relative p-3 rounded-lg bg-gradient-to-br from-orange-50 to-red-50 border border-orange-200 transition-all duration-300 ${
