    ...
    <PageTransition>
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 p-6">
        <div className="max-w-7xl mx-auto space-y-8">
          <ScrollFadeIn yOffset={32}><div className="text-center space-y-4">
          ...
          <ScrollFadeIn yOffset={22} delay={0.04}><div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <ScrollFadeIn yOffset={18} delay={0.08}><Tabs value={activeDemo} onValueChange={setActiveDemo} className="w-full">
          ...
          <ScrollFadeIn yOffset={16} delay={0.12}><Card className="bg-gradient-to-r from-primary/5 to-purple-100/50">
