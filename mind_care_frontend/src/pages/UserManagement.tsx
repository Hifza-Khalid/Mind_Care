    ...
    <PageTransition>
      <div className="min-h-screen bg-gradient-to-br from-primary/5 via-secondary/5 to-accent/5 p-8">
        <div className="container mx-auto space-y-8">
          {/* Header */}
          <ScrollFadeIn yOffset={32}><div className="flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-4 lg:space-y-0">
          ...
          <ScrollFadeIn yOffset={22} delay={0.04}><div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
          ...
          <ScrollFadeIn yOffset={18} delay={0.08}><Card className="bg-white/10 backdrop-blur-xl border-white/20">
            <CardHeader>
          ...
          {selectedUsers.length > 0 && (
            <ScrollFadeIn yOffset={16} delay={0.10}><Card className="bg-gradient-to-r from-primary/10 to-secondary/10 backdrop-blur-xl border-primary/20">
          ...
          {/* Users Table/Cards */}
          <ScrollFadeIn yOffset={14} delay={0.13}><Card className="bg-white/10 backdrop-blur-xl border-white/20">
            <CardHeader>
