  ...
  return (
    <PageTransition>
      <div className="container mx-auto px-4 py-8 space-y-8">
        <ScrollFadeIn yOffset={32}><div className="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
          <div>
        ...
        <ScrollFadeIn yOffset={20} delay={0.03}><div className="grid grid-cols-1 md:grid-cols-5 gap-6">
          <Card>
        ...
        <ScrollFadeIn yOffset={18} delay={0.06}><Card>
          <CardHeader>
        ...
        <ScrollFadeIn yOffset={14} delay={0.09}><Card>
          <CardHeader>
