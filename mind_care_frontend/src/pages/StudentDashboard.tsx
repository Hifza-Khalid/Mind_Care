    ...
    <PageTransition>
      <div className="min-h-screen bg-gradient-mesh">
        <div className="container mx-auto px-3 sm:px-4 lg:px-6 py-6 sm:py-8 space-y-8 sm:space-y-12 max-w-7xl">
          <ScrollFadeIn yOffset={32}><section className="text-center space-y-6 fade-in">
          ...
          <ScrollFadeIn yOffset={28} delay={0.05}><section className="space-y-6">
          ...
          <ScrollFadeIn yOffset={28} delay={0.08}><section className="space-y-6">
            <div className="text-center">
              <h2 className="text-2xl sm:text-3xl font-bold text-heading mb-2">
                Quick Mood Check-in
              </h2>
          ...
          <ScrollFadeIn yOffset={28} delay={0.10}><section className="space-y-6">
            <div className="text-center">
              <h2 className="text-2xl sm:text-3xl font-bold text-heading mb-2">
          ...
          <ScrollFadeIn yOffset={28} delay={0.12}><section className="space-y-6">
            <EnhancedDailyTips />
          </section></ScrollFadeIn>

          {/* Quick Wellness Tools */}
          <ScrollFadeIn yOffset={28} delay={0.14}><section className="space-y-6">
            <div className="text-center">
              <h2 className="text-2xl sm:text-3xl font-bold text-heading mb-2">
                Quick Wellness Tools
              </h2>
          ...
          {/* Quick Actions Bar */}
          <ScrollFadeIn yOffset={28} delay={0.16}><section className="enhanced-card bg-gradient-to-r from-primary/5 to-secondary/5 border-primary/20 p-6 sm:p-8">
          ...
          <ScrollFadeIn yOffset={28} delay={0.18}><section className="enhanced-card bg-gradient-to-br from-red-50/80 to-orange-50/80 border-red-200/60 p-6 sm:p-8">
